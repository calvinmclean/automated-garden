...
func TestGetWaterSchedule(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			"Successful",
			false,
			func() *pkg.WaterSchedule {
				ws := createExampleWaterSchedule()
				ws.NotificationSettings = &pkg.WaterScheduleNotificationSettings{
					WateringReminder: true,
					WateringErrors:   true,
				}
				return ws
			}(),
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1s","interval":"1d","start_date":"\d{4}-\d{2}-\d{2}","start_time":"11:24:52\-07:00","notification_settings":{"watering_reminder":true,"watering_errors":true},"next_water":{"time":"\d\d\d\d-\d\d-\d\dT11:24:52\-07:00","duration":"1s"},"links":\[{"rel":"self","href":"/water_schedules/c5cvhpcbcv45e8bp16dg"}\]}`,
		},
		{
			...
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1h","interval":"1d","start_date":"\d{4}-\d{2}-\d{2}","start_time":"11:24:52-07:00","weather_control":{"rain_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":0,"input_max":30,"factor_min":1,"factor_max":0},"temperature_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":20,"input_max":40,"factor_min":0.5,"factor_max":1.5}},"weather_data":{"rain":{"mm":25.4,"inches":1},"temperature":{"celsius":80,"fahrenheit":176}},"next_water":{"time":"\d\d\d\d-\d\d-\d\dT11:24:52-07:00","duration":"13m48s"},"links":\[{"rel":"self","href":"/water_schedules/c5cvhpcbcv45e8bp16dg"}\]}`,
		},
		{
			...
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1h","interval":"1d","start_date":"\d{4}-\d{2}-\d{2}","start_time":"11:24:52-07:00","weather_control":{"rain_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":0,"input_max":25.4,"factor_min":1,"factor_max":1},"temperature_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":20,"input_max":40,"factor_min":0.5,"factor_max":1.5}},"next_water":{"time":"\d\d\d\d-\d\d-\d\dT11:24:52-07:00","duration":"1h"},"links":\[{"rel":"self","href":"/water_schedules/c5cvhpcbcv45e8bp16dg"}\]}`,
		},
		{
			...
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1h","interval":"1d","start_date":"\d{4}-\d{2}-\d{2}","start_time":"11:24:52-07:00","weather_control":{"rain_control":{"client_id":"chkodpg3lcj13q82mq40","interpolation":"linear","input_min":0,"input_max":25.4,"factor_min":1,"factor_max":0}},"weather_data":{},"next_water":{"time":"\d\d\d\d-\d\d-\d\dT11:24:52-07:00","duration":"1h","message":"error impacted duration scaling"},"links":\[{"rel":"self","href":"/water_schedules/c5cvhpcbcv45e8bp16dg"}\]}`,
		},
		{
...
func TestUpdateWaterSchedule(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			"Successful",
			`{"duration":"1h"}`,
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1h","interval":"1d","start_date":"\d{4}-\d{2}-\d{2}","start_time":"11:24:52-07:00","next_water":{"time":"\d\d\d\d-\d\d-\d\dT11:24:52-07:00","duration":"1h"},"links":\[{"rel":"self","href":"/water_schedules/c5cvhpcbcv45e8bp16dg"}\]}`,
			http.StatusOK,
		},
		{
			"BadRequest",
...
func TestCreateWaterSchedule(t *testing.T) {
	tests := []struct {
		...
		{
			"ErrorDurationZero",
			`{"duration":"0s","interval":"1d","start_time":"11:24:52-07:00"}`,
		...
		{
			"ErrorRainWeatherClientDNE",
			`{"duration":"1s","interval":"1d","start_time":"11:24:52-07:00", "weather_control":{"rain_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":0,"input_max":25.4,"factor_min":0,"factor_max":0}}}`,
		...
		{
			"ErrorTemperatureWeatherClientDNE",
			`{"duration":"1s","interval":"1d","start_time":"11:24:52-07:00", "weather_control":{"temperature_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":0,"input_max":25.4,"factor_min":0,"factor_max":0}}}`,
		...
		},
		{
			...
			`{"duration":"1s","interval":"1d","start_time":"invalid"}`,
		...
		{
			"ErrorCannotSetID",
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1s","interval":"1d","start_time":"11:24:52-07:00"}`,
...
func TestUpdateWaterSchedulePUT(t *testing.T) {
	tests := []struct {
		...
		{
			"ErrorWrongID",
			`{"id":"chkodpg3lcj13q82mq40","duration":"1s","interval":"1d","start_time":"11:24:52-07:00"}`,
			`{"status":"Invalid request.","error":"id must match URL path"}`,
			http.StatusBadRequest,
		},
		{
			"ErrorRainWeatherClientDNE",
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1s","interval":"1d","start_time":"11:24:52-07:00", "weather_control":{"rain_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":0,"input_max":25.4,"factor_min":0,"factor_max":0}}}`,
			`{"status":"Invalid request.","error":"unable to get WeatherClients for WaterSchedule: error getting client for RainControl: error getting WeatherClient with ID \\"c5cvhpcbcv45e8bp16dg\\": resource not found"}`,
			http.StatusBadRequest,
		},
		{
			"ErrorTemperatureWeatherClientDNE",
			`{"id":"c5cvhpcbcv45e8bp16dg","duration":"1s","interval":"1d","start_time":"11:24:52-07:00", "weather_control":{"temperature_control":{"client_id":"c5cvhpcbcv45e8bp16dg","interpolation":"linear","input_min":0,"input_max":25.4,"factor_min":0,"factor_max":0}}}`,
			`{"status":"Invalid request.","error":"unable to get WeatherClients for WaterSchedule: error getting client for TemperatureControl: error getting WeatherClient with ID \\"c5cvhpcbcv45e8bp16dg\\": resource not found"}`,
			http.StatusBadRequest,
		},
		{
