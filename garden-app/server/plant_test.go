...
func TestUpdatePlant(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			`{"name":"new name"}`,
			`{"name":"new name","id":"c5cvhpcbcv45e8bp16dg","garden_id":null,"plant_position":0,"created_at":"2021-10-03T11:24:52.891386-07:00","water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"},"next_watering_time":"0001-01-01T00:00:00Z","links":[{"rel":"self","href":"/gardens/00000000000000000000/plants/c5cvhpcbcv45e8bp16dg"},{"rel":"garden","href":"/gardens/00000000000000000000"},{"rel":"action","href":"/gardens/00000000000000000000/plants/c5cvhpcbcv45e8bp16dg/action"},{"rel":"history","href":"/gardens/00000000000000000000/plants/c5cvhpcbcv45e8bp16dg/history"}]}`,
			http.StatusOK,
		},
		{
			"BadRequest",
...
func TestEndDatePlant(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			createExamplePlant(),
			`{"name":"test plant","id":"[0-9a-v]{20}","garden_id":null,"plant_position":0,"created_at":"\d{4}-\d{2}-\d\dT\d\d:\d\d:\d\d\.\d+(-07:00|Z)","end_date":"\d{4}-\d{2}-\d\dT\d\d:\d\d:\d\d\.\d+(-07:00|Z)","water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"},"links":\[{"rel":"self","href":"/gardens/[0-9a-v]{20}/plants/[0-9a-v]{20}"},{"rel":"garden","href":"/gardens/[0-9a-v]{20}"}\]}`,
			http.StatusOK,
		},
		{
...
func TestCreatePlant(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			createExampleGarden(),
			`{"name":"test plant","plant_position":0,"water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"}}`,
			`{"name":"test plant","id":"[0-9a-v]{20}","garden_id":"[0-9a-v]{20}","plant_position":0,"created_at":"\d{4}-\d{2}-\d\dT\d\d:\d\d:\d\d\.\d+(-07:00|Z)","water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"},"next_watering_time":"0001-01-01T00:00:00Z","links":\[{"rel":"self","href":"/gardens/[0-9a-v]{20}/plants/[0-9a-v]{20}"},{"rel":"garden","href":"/gardens/[0-9a-v]{20}"},{"rel":"action","href":"/gardens/[0-9a-v]{20}/plants/[0-9a-v]{20}/action"},{"rel":"history","href":"/gardens/[0-9a-v]{20}/plants/[0-9a-v]{20}/history"}\]}`,
			http.StatusCreated,
		},
		{
			...
			func(storageClient *storage.MockClient) {},
			createExampleGarden(),
			`{"name":"test plant","plant_position":-1,"water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"}}`,
		...
		},
		{
			...
			func(storageClient *storage.MockClient) {},
			createExampleGarden(),
			`{"name":"test plant","plant_position":0,"skip_count":-1,"water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"}}`,
		...
		},
		{
			...
			func(storageClient *storage.MockClient) {},
			createExampleGarden(),
			`{"name":"test plant","plant_position":2,"water_schedule":{"duration":"1000ms","interval":"24h","start_time":"22:00:01-07:00"}}`,
			...
			func(influxdbClient *influxdb.MockClient) {
				influxdbClient.On("GetWateringHistory", mock.Anything, uint(0), "test-garden", time.Hour*72).
					Return([]map[string]interface{}{
						...
						{"Duration": 3000, "RecordTime": recordTime.Add(1 * time.Hour)},
					}, nil)
				influxdbClient.On("Close")
			},
			"?limit=1",
