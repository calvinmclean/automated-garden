...
// AuthorizationsAPI provides a mock function with no fields
...
// BucketsAPI provides a mock function with no fields
...
// DeleteAPI provides a mock function with no fields
...
func (_m *MockClient) GetLastContact(_a0 context.Context, _a1 string) (time.Time, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLastContact")
	}
...
func (_m *MockClient) GetTemperatureAndHumidity(_a0 context.Context, _a1 string) (float64, float64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTemperatureAndHumidity")
	}
...
// GetWaterHistory provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4, _a5
func (_m *MockClient) GetWaterHistory(_a0 context.Context, _a1 string, _a2 string, _a3 time.Duration, _a4 uint64, _a5 bool) ([]pkg.WaterHistory, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5)

	if len(ret) == 0 {
		panic("no return value specified for GetWaterHistory")
	}

	var r0 []pkg.WaterHistory
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration, uint64, bool) ([]pkg.WaterHistory, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4, _a5)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration, uint64, bool) []pkg.WaterHistory); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, time.Duration, uint64, bool) error); ok {
...
// LabelsAPI provides a mock function with no fields
...
// OrganizationsAPI provides a mock function with no fields
...
// ServerURL provides a mock function with no fields
...
// TasksAPI provides a mock function with no fields
...
// UsersAPI provides a mock function with no fields
