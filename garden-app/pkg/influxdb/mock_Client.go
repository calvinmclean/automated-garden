...
func (_m *MockClient) GetWaterHistory(_a0 context.Context, _a1 string, _a2 string, _a3 time.Duration, _a4 uint64) ([]pkg.WaterHistory, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration, uint64) ([]pkg.WaterHistory, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration, uint64) []pkg.WaterHistory); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, time.Duration, uint64) error); ok {
